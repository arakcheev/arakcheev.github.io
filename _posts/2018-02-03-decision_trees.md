...
соответсвенно означают метрику качества разбиения, которая чем меньше, тем лучше, размер подмножества и метрику разброса ответов. Действительно, отношение размеров подмножества к исходному значению показывает значимость подмножества для метрики качества: если $|X_i| = 1$, то метрика разброса ответов $H(X_i)$ практически не важна.
